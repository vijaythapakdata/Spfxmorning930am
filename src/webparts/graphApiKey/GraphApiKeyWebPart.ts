...
import { INasaItemSearchResponse } from '../../Models/INasaImageSearchResponse';
...
if(!this.renderedOnce){
  ...
  const nasaResponse:INasaItemSearchResponse=await this.getAppolloMissionImages();
    ...
    const element: React.ReactElement<IGraphApiKeyProps> = React.createElement(
      GraphApiKey,
      {
        ...
        userDisplayName: this.context.pageContext.user.displayName,
         apolloMissionImage:nasaResponse.collection.items[0]
  ...
  //get images
  private async getAppolloMissionImages():Promise<INasaItemSearchResponse>{
    ...
    return responseJson as INasaItemSearchResponse;
  }
}
